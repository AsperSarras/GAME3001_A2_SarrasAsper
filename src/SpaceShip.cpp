...
SpaceShip::SpaceShip()
{
	TextureManager::Instance()->load("../Assets/textures/ship2.png", "spaceship");
...
void SpaceShip::setStopRadius(float stopR)
{
	m_stopRadius = stopR;
}
...
void SpaceShip::m_Move()
{
	...
	float dist = Util::distance(getTransform()->position, m_destination);
